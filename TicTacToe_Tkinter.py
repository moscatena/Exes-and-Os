...
"""
See Board at all times
Choose next move
See moves made by all
see who won and why
bea ble to quit and go again after each cycle
...
root.title('Exes and Oes')
#root.iconbitmap('d:/Scat/DCMI/eu/me')
...
def play_again():
    a = messagebox.askyesno(title='Play Again', message='Would you like to play again?')
    if a == True:
        reset()
    else:
        messagebox.showinfo(title='See ya!', message='Thanks for playing. See you later!')
        root.destroy()
...
def checkifwon():
    ...
    if b1['text'] == 'X' and b2['text'] == 'X' and b3['text'] == 'X':
        ...
        b3.config(bg='red')
        winner = True
        messagebox.showinfo('Exes and Oes', 'Good jub buddy. X won.')
        disable_all_buttons()
    ...
    if b1['text'] == 'O' and b2['text'] == 'O' and b3['text'] == 'O':
        ...
        b3.config(bg='red')
        winner = True
        messagebox.showinfo('Exes and Oes', 'Good jub buddy. O won.')
        disable_all_buttons()
    ...
    if b2['text'] == 'O' and b5['text'] == 'O' and b8['text'] == 'O':
        ...
        messagebox.showinfo('Exes and Oes', 'Good jub buddy. O won.')
        disable_all_buttons()
    if b3['text'] == 'O' and b6['text'] == 'XO' and b9['text'] == 'O':
        b3.config(bg='red')
        b6.config(bg='red')
        b9.config(bg='red')
        winner = True
    ...
    if count == 9 and winner == False:
        messagebox.showinfo('Exes and Oes', 'You tied it up dummy. All loosers.')
        disable_all_buttons()
...
def b_click(b):
    ...
    if b['text'] == ' ' and clicked == True:
        ...
        messagebox.showerror('Exes and Oes', "Choose a valid box dummy\nI'm waiting")
    checkifwon()
